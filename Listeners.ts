...
function Initialize() {
  ...
  let node : HTMLInputElement = <HTMLInputElement> document.getElementById("settingTabs");
...
document.getElementById("swapButton").addEventListener("click", () => {
  const inputNode : HTMLInputElement = <HTMLInputElement> document.getElementById("inputField");
  const outputNode : HTMLInputElement = <HTMLInputElement> document.getElementById("outputField");
